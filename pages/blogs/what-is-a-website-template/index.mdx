...
export const meta = {
  ...
  description:
    "A website template is a pre-designed resource that shows the structure for the comprehensive layout and display features of any website. It is a ready-made web design that you can use to plug in your own content.",
  categories: ["Web Development", "Design"],
  tags: ["templates", "web design", "development", "beginners", "html"]
};
